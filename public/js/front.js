...
$(".search-form").submit(function(e) {
    let cat = $('#front-search-form input[name="category"]:checked').val();
    ...
    var n = $("#header-search-form").val(),
        c = n.replace(" ", "+");
    window.location.href = APP_URL + "/s?category=" + cat +  "&location=" + c + "&checkin=" + t + "&checkout=" + a + "&guest=" + o;
    e.preventDefault()
})
...
$("#front-search-form").submit(function(e) {
    ...
    var t = $("#startDate").val(),
        ...
        i = "";
    var n = $("#front-search-address").val(),
        c = n.replace(" ", "+");
    window.location.href = APP_URL + "/search?category=" + cat + "&location=" + c + "&checkin=" + t + "&checkout=" + a + "&guest=" + o;
    e.preventDefault()
});
