...
use App\DataTables\PropertyAddRequestDataTable;
...
class PropertiesController extends Controller
{
    ...
    public function addRequests(PropertyAddRequestDataTable $dataTable)
    {
        ...
        return $dataTable->render('admin.properties.add-request', $data);
    }
    ...
    public function requestApprove($id)
    {
        ...
        $this->helper->one_time_message('success', 'Requested property is approved');
        return back();
    }
...
//                    'latitude'          => 'required|not_in:0',
            ...
            if ($request->isMethod('post')) {
                ...
                if ($validator->fails()) {
                    ...
                    $property_price->guest_after       = $request->has('additional_guest_pricing') ? $data['result']->accommodates : 0;
