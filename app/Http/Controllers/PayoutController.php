...
class PayoutController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['countries'] = Country::where('short_name', 'PK')->get();
        $data['paymentMethods'] = PaymentMethods::whereNotIn('name', ['Revepay', 'Stripe', 'Wallet'])->get();
        $data['currentCurrency'] = Currency::getAll()->firstWhere(
            'code',
        ...
        if (!$request->isMethod('post')) {
            ...
            if ($request->payout_type == 1) {
                ...
                $rules = array(
                    ...
                    // 'swift_code'                  => ['nullable', 'max:255', 'not_regex:/[!@#$%^&*\(\)=|\[\{\}\]\/+]/i'],
