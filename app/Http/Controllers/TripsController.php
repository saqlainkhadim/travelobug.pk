...
use App\Models\{Bookings, BookingDetails, Messages, Penalty, Payouts, Properties, PayoutPenalties, PropertyDates, PropertyFees, Settings};
...
class TripsController extends Controller
{
    ...
    public function myTrips(Request $request)
    {
        ...
        $bookings  = Bookings::with('host', 'properties')
        ...
        return request('category') !== 'activity' ? view('trips.active', $data) : view('trips.active-activity', $data);
    }
