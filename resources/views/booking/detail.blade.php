	...
	<div class="row mb-4">
		<div class="col-md-8 card p-5">
			...
			<div class="row flex-column-reverse flex-md-row mt-4 m-0">
				<div class="col-md-9 p-0">
					<p class="text-justify">{{ $result->users->first_name }} {{ $result->users->last_name }} has requested to book your {{ $result->category ?? 'property' }}. Please accept or Decline this request.</p>
        ...
        <div class="col-md-4">
            <div class="card mt-3 mb-5 p-3">
                ...
                @else
                <a href="{{ url('/') }}/activities/{{ $result->activity->slug}}">
                    <img class="card-img-top p-2 rounded" src="{{$result->activity->cover_photo}}" alt="{{$result->activity->name}}" height="180px">
                </a>
                @endif
                ...
                <div class="card-body p-4">
                    ...
                    @else
                    <a href="{{ url('/') }}/activities/{{ $result->activity->slug}}">
                        <p class="text-16 font-weight-700 mb-0">{{ $result->activity->name }}</p>
                    </a>
                    @endif
                    ...
                    <p class="text-14 mt-2 text-muted mb-0">
                        ...
                        @else
                        {{$result->activity->address->address_line_1}}, {{ $result->activity->address->state }}, {{ $result->activity->address->country_name }}
                        @endif
                    </p>
                    <div class="border p-4 mt-3 text-center rounded-3">
                        <p class="text-16 mb-0">
                            ...
                            @else
                            <strong class="font-weight-700 secondary-text-color">{{ $result->activity->property_type_name }}</strong>
                            @endif
