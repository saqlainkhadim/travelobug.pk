...
@section('main')
<div class="container mb-4 margin-top-85 min-height" style="padding-top:70px">
                ...
                @if($social['facebook_login'])
                    <a href="{{ isset($facebook_url) ? $facebook_url:URL::to('facebookLogin') }}">
                        <button class="btn btn-outline-primary pt-3 pb-3 text-16 w-100">
                            <span><i class="fab fa-facebook-f mr-2 text-16"></i> {{trans('messages.sign_up.sign_in_with_facebook')}}</span>
                        </button>
                    </a>
                @endif
                ...
                @if($social['google_login'])
                    <a href="{{URL::to('googleLogin')}}">
                        <button class="btn btn-outline-danger pt-3 pb-3 text-16 w-100 mt-3">
                            <span><i class="fab fa-google-plus-g  mr-2 text-16"></i>  {{trans('messages.sign_up.sign_in_with_google')}}</span>
                        </button>
                    </a>
                @endif
