		...
		<div class="modal-content">
			...
			<div class="modal-body pl-5 pr-5">
				<form method="post" action="hotel_date_package/" class='form-horizontal' id='dtpc_form'>
					...
					<input type="hidden" value="{{ $result->id }}" name="activity_id" id="dtpc_property_id">
				...
				<form id='icalendar_form'>
					...
					<div class="form-group">
						<div class="col-md-12 p-0 text-right mt-5">
							...
							<button class="btn vbtn-outline-success pull-right text-16 pl-4 pr-4 mr-2" type="submit" id="import_btn" name="Import">
								<i class="spinner fa fa-spinner fa-spin d-none" id="import_spinner" ></i>
				...
				<div class="row justify-content-center">
					...
					<div class="col-md-9 mt-sm-0 pl-4 pr-4">
						...
						<div class="row justify-content-between mt-4 mb-5">
							<div class="mt-4">
								<a  data-prevent-default="" href="{{ url('activity/listing/'.$result->id.'/booking') }}" class="btn btn-outline-danger secondary-text-color-hover text-16 font-weight-700 pl-5 pr-5 pt-3 pb-3">
									{{trans('messages.listing_description.back')}}
								</a>
							</div>

							<div class="mt-4">
							<a  data-prevent-default="" href="{{ url('activities/'.$result->slug) }}" class="btn vbtn-outline-success text-16 font-weight-700 pl-5 pr-5 pt-3 pb-3" id="btn_next">
