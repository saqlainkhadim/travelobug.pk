					...
					<div class="main-panel min-height mt-4">
						<div class="row justify-content-center">
							...
							<div class="col-md-9 mt-4 mt-sm-0 pl-4 pr-4">
								<form id="img_form" enctype='multipart/form-data' method="post" action="{{url('activity/listing/'.$result->id.'/'.$step)}}" accept-charset='UTF-8'>
									{{ csrf_field() }}
									<div class="row">
                                                                ...
                                                                @foreach ($photos as $photo)
                                                                    ...
                                                                    <div class="col-md-6 mt-5"
                                                                        ...
                                                                        <div class="room-image-container200"
                                                                             style="background-image:url('{{ url('public/images/activity/' . $photo->activity_id . '/' . $photo->photo) }}');">
									...
									<div class="col-md-12 p-0 mt-4 mb-5">
										<div class="row m-0 justify-content-between">
											<div class="mt-4">
												<a href="{{ url('activity/listing/'.$result->id.'/amenities') }}" class="btn btn-outline-danger secondary-text-color-hover text-16 font-weight-700  pt-3 pb-3 pl-5 pr-5">
											...
											<div class="mt-4">
												...
												<a href="{{url('activity/listing/'.$result->id.'/pricing')}}" class="btn vbtn-outline-success text-16 font-weight-700 pl-5 pr-5 pt-3 pb-3 pl-5 pr-5" id="btnnext"><i class="spinner fa fa-spinner fa-spin d-none" id="btn_spin"></i>
	...
	@push('scripts')
		...
		<script type="text/javascript">
			...
			$(document).on('focusout', '.photo-highlights', function(e){
					var dataURL = '{{url("activity/listing/".$result->id."/photo_message")}}';
			...
			$(document).on('click', '.photo-delete', function(e){
				...
				.then((willDelete) => {
					if (willDelete) {
						var dataURL  = '{{url("activity/listing/$result->id/photo_delete")}}';
			...
			$(document).on('change', '#photoId', function(ev){
				var dataURL      = '{{url("activity/listing/photo/make_default_photo")}}';
			...
			$(document).on('change', '.serial', function(ev){
				var dataURL = '{{url("activity/listing/photo/make_photo_serial")}}';
				var serial = $(this).val();
