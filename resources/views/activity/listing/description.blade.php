			...
			<div class="main-panel min-height mt-4">
				<div class="row justify-content-center">
					...
					<div class="col-md-9 mt-4 mt-sm-0 pl-4 pr-4">
						<form method="post" id="list_des" action="{{url('activity/listing/'.$result->id.'/'.$step)}}"  accept-charset='UTF-8'>
							{{ csrf_field() }}
							<div class="col-md-12 border mt-4 pb-5 rounded-3 pl-sm-0 pr-sm-0 ">
								...
								<div class="row mt-4">
									<div class="col-md-12 pl-5 pr-5">
										<p>
											{{trans('messages.listing_description.add_more')}} <a href="{{ url('activity/listing/'.$result->id.'/details') }}" class="secondary-text-color" id="js-write-more">{{trans('messages.listing_description.detail')}}</a> {{trans('messages.listing_description.detail_data')}}.
										</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-12 p-0 mt-4 mb-5">
								<div class="row m-0 justify-content-between">
									<div class="mt-4">
										<a  href="{{ url('activity/listing/'.$result->id.'/basics') }}" class="btn btn-outline-danger secondary-text-color-hover text-16 font-weight-700  pt-3 pb-3 pl-5 pr-5">
