				...
				<div class="main-panel min-height mt-4">
					<div class="row justify-content-center">
						...
						<div class="col-md-9 mt-sm-0 pl-4 pr-4">
							<form id="booking_id" method="post" action="{{url('activity/listing/'.$result->id.'/'.$step)}}"  accept-charset='UTF-8'>
								{{ csrf_field() }}
								...
								<div class="col-md-12 mt-4 p-0 mb-5">
									<div class="row justify-content-between">
										<div class="mt-4">
											<a href="{{ url('activity/listing/'.$result->id.'/pricing') }}" class="btn btn-outline-danger secondary-text-color-hover text-16 font-weight-700 pl-5 pr-5 pt-3 pb-3">
