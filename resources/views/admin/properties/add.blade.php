                    ...
                    <div class="box box-info">
                        ...
                        <form id="add_pr" class="form-horizontal" method="post" action="{{ url('admin/add-properties') }}" id="lys_form" accept-charset='UTF-8'>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1" class="control-label col-sm-3">{{ trans('messages.property.category') }}</label>
                                    <div class="col-sm-6">
                                        <select name="property_category" class="form-control">
                                            <option data-icon-class="icon-star-alt" value="hotel">Hotel</option>
                                            <option data-icon-class="icon-star-alt" value="guest_house">Guest House</option>
                                        </select>
                                    </div>
                                    @if ($errors->has('property_category'))
                                        <p class="error-tag">{{ $errors->first('property_category') }}</p>
                                    @endif
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" id="signup_form" method="post" name="signup_form" accept-charset='UTF-8'>
                            ...
                            <h4 class="text-info ml-40 text-center">Customer Information</h4>
    ...
    @push('scripts')
        ...
        <script type="text/javascript">
            ...
            function updateControls(addressComponents) {
                ...
                if (typeof(addressComponents.city) !== 'undefined' && addressComponents.country !== 'undefined' && typeof(addressComponents.city) !== null && addressComponents.country !== null && typeof(addressComponents.city) !== '' && addressComponents
                    .country !== '') {
