				...
				<div class="col-md-8 col-sm-offset-2">
					<div class="box box-info box_info">
						...
						<form action="{{ url('admin/bookings/detail/'.$result->id) }}" method="post" class='form-horizontal'>
							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-6 col-sm-offset-1">
										{{ ucfirst($result->activity->user->first_name) }}
									</div>
								</div>
                                ...
                                @if($result->bank_id)
                                    ...
                                    @if(($result->status == 'Pending' && $result->booking_type == 'instant') || $result->status ==  'Processing')
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-sm-offset-1">
                                                <div class="d-flex">
                                                    <a href="{{url('/admin/bookings-activity/edit/confirm/'.$result->id)}}" class="btn btn-sm btn-info btn-outline-info">Accept</a>
                                                    <a href="{{url('/admin/bookings-activity/edit/decline/'.$result->id)}}" class="btn text-danger btn-outline-danger">Decline</a>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
						...
						<div class="box-footer text-center">
							<a class="btn btn-default" href="{{ url('admin/bookings-property') }}">Back</a>
						</div>
					</div>
				</div>
			</div>
