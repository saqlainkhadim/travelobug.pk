				...
				<section class="content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="box">
								<div class="box-body">
									<form class="form-horizontal" enctype='multipart/form-data' action="{{ url('admin/bookings-property') }}" method="GET" accept-charset="UTF-8">
										{{ csrf_field() }}
	...
	ajax: {
		url: 'bookings-property/property_search',
	...
	ajax: {
		url: 'bookings-property/customer_search',
		processResults: function (data) {
		$('#customer').val('DSD');
		return {
			results: data
