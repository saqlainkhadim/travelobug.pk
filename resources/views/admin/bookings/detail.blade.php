                                ...
                                @if($result->bank_id)
                                    ...
                                    @if(($result->status == 'Pending' && $result->booking_type == 'instant') || $result->status ==  'Processing')
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-sm-offset-1">
                                                <div class="d-flex">
                                                    <a href="{{url('/admin/bookings-property/edit/confirm/'.$result->id)}}" class="btn btn-sm btn-info btn-outline-info">Accept</a>
                                                    <a href="{{url('/admin/bookings-property/edit/decline/'.$result->id)}}" class="btn text-danger btn-outline-danger">Decline</a>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
