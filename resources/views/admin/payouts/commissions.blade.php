                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="panel panel-primary">
                                        <div class="panel-body text-center">
                                            <span class="text-20">{{ $totalCommisionAmount }}</span><br>
                                            Total<span class="total-amount font-weight-bold"> </span> commission
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        $(function() {
            ...
            $(document).ready(function() {
                $('#dataTableBuilder_length').after(
                    '<div id="exportArea" class="col-md-4 col-sm-4 "><div class="row mt-m-2"><div class="btn btn-group btn-refresh"><a href="" id="tablereload" class="form-control"><span><i class="fa fa-refresh"></i></span></a></div></div></div>'
                    );
            });
