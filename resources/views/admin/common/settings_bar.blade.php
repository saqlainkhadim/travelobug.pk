	...
	<div class="panel-body">
		...
		<ul class="nav navbar-pills nav-tabs nav-stacked no-margin" role="tablist">
			...
			@if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'starting_cities_settings'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/addresses') || (Route::current()->uri() == 'admin/settings/add-address') || (Route::current()->uri() == 'admin/settings/edit-address/{id}') ? 'active' : ''  }}">
					<a href="{{ url('admin/settings/addresses') }}" data-group="home_cities">Addresses</a>
				</li>
			@endif
            ...
            {{-- activity --}}
            @if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_property_type'))
                <li class="{{ (Route::current()->uri() == 'admin/settings/activity-type' || Route::current()->uri() == 'admin/settings/add-activity-type' || Route::current()->uri() == 'admin/settings/edit-activity-type/{id}') ? 'active' : ''  }}">
                    <a href="{{ url('admin/settings/activity-type') }}" data-group="activity_type">Activity Type</a>
                </li>
            @endif
