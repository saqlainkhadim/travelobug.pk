                ...
                <div class="col-md-9">
                    <div class="box box-info">
                        <div class="box-body">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="admin/hotel_date_package/" class='form-horizontal' id='dtpc_form'>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" value="{{ $result->id }}" name="activity_id" id="dtpc_activity_id">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form class='form-horizontal' id='icalendar_form'>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" value="{{ $result->id }}" name="activity_id" id="icalendar_activity_id">
                                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <form method='post' action="admin/activity-save/{{ $result->id }}/pricing">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="hidden" id="dtpc_activity_id" value="{{ $result->id }}">
                                            <div id="calender-dv">
                                                {!! $calendar !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-6 mt-30 text-left">
                                            <a data-prevent-default="" href="{{ url('admin/activity/listing/' . $result->id . '/booking') }}" class="btn btn-large btn-primary">{{ trans('messages.listing_description.back') }}</a>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6 mt-30 text-right">
                                            <a data-prevent-default="" href="{{ url('admin/activities') }}" class="btn btn-large btn-primary">{{ trans('messages.listing_calendar.your_list') }}</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
