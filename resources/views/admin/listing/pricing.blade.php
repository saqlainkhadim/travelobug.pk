        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <label for="listing_cleaning_fee_native_checkbox" class="label-large label-inline">
              <input type="checkbox" class="pricing_checkbox" data-rel="additional-guests" name="additional_guest_pricing" {{($result->property_price->original_guest_fee == 0)?'':'checked="checked"'}}>&nbsp
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-4">
                <select id="price-select-guests_included" name="guest_after" data-saving="additional-saving" class="form-control">
                  @for($i=$result->accommodates;$i<=16;$i++)
