                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mt-4">
                                ...
                                <select name="category" class="form-control text-16">
                                        <option data-icon-class="icon-star-alt"  value="hotel">{{__('Hotel')}}</option>
                                        <option data-icon-class="icon-star-alt"  value="guest_house">{{__('Guest House')}}</option>
                                </select>
                                @if ($errors->has('category')) <p class="error-tag">{{ $errors->first('category') }}</p> @endif
                            </div>
                        </div>
						<div class="col-md-6">
							<div class="form-group mt-4">
						...
						<div class="col-md-12">
							<div class="form-group mt-4">
								...
								<div class="position-relative">
									<input type="text" class="form-control text-16 address_input" name="map_address" placeholder="">
