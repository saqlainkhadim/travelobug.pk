					...
					<div class="col-md-12">
						...
						<div class="row justify-content-center mt-5">
                            ...
                            <div class="col-md-12 mt-4 p-0 mb-5">
                                <div class="card card-default">
                                    <div class="main-panel border main-panelbg">
                                        <p class="p-2 pl-4 font-weight-700">
                                            Get Verification Badge
                                        </p>
                                    </div>
                                    <div class="p-4">
                                        @if (auth()->user()->is_verified && auth()->user()->verified_at)
                                        <div class="fa fa-shield"></div>
                                        <strong class="text-success">Your account is verified! You have already got and verification badge.</strong>
                                        @else
                                        Submit your CNIC & Legal Business Details via Email | verification@travelobug.pk
                                        @endif
                                    </div>
                                </div>
                            </div>
										...
										<div class="row pl-4 pt-1">
											...
											<div>
												<a href="{{ url('users/new_email_confirm?redirect=verification') }}">
													<button type="button" class="btn btn-outline-success pl-4 pr-4 pt-3 pb-3 text-14 text-weight-700 w-100">{{ trans('messages.profile.verify') }}</button>
												</a>
											</div>
											</div>
										</div>
