                                ...
                                <div class="col-md-9 pl-2">
                                    <div class="row m-0 pr-4 w-100">
                                        ...
                                        <div class="col-2 col-sm-3">
                                            <span data-status="{{$booking->properties->book_mark}}"  data-id="{{$booking->properties->id}}" class="book_mark_change cursor-pointer" style="font-size: 22px; color: var(--scheme-color);">
