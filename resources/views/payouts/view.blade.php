			...
			<form action="{{url('users/payout/setting')}}" id="add_payout_setting" method="post" name="add_payout_setting" accept-charset='UTF-8'>
				...
				<div class="row p-4">
					...
					<div class="col-md-6" id="branch_c">
						<div class="form-group">
							<label for="exampleInputPassword1">{{trans('messages.account_preference.branch_city')}}</label>
					...
					<div class="col-md-6" id="branch_ad">
						<div class="form-group">
							<label for="exampleInputPassword1">{{trans('messages.account_preference.branch_address')}}</label>
					...
					<div class="col-md-6" id="country_id">
						<div class="form-group">
							<label for="exampleInputPassword1" class="control-label">{{trans('messages.payment.country')}}</label>
